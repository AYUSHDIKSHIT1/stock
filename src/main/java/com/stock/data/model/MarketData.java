...
public class MarketData {
	...
	public MarketData(int id, int strikePrice, String time, double currentPrice, long cEoi,
	...
	public String toString() {
		return "MarketData [id=" + id + ", upPcr=" + upPcr + ", dnPcr=" + dnPcr + ", strikePrice=" + strikePrice
