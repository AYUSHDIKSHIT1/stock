...
@Entity
@Table(name="two_StrikeDown")
public class downerDown
{
	...
	public downerDown(int id, int strikePrice, String time, double currentPrice, long cEoi,
	...
	public String toString() {
		return "downerDown [id=" + id + ", upPcr=" + upPcr + ", dnPcr=" + dnPcr + ", strikePrice=" + strikePrice
