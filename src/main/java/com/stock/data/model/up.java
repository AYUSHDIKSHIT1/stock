...
public class up {
	...
	public up(int id, int strikePrice, String time, double currentPrice, long cEoi,
	...
	public String toString() {
		return "up [id=" + id + ", upPcr=" + upPcr + ", dnPcr=" + dnPcr + ", strikePrice=" + strikePrice
